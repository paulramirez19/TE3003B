    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                's7_robot_network_interface.msg.RobotStatus')
            logger.debug(
...
class RobotStatus(metaclass=Metaclass_RobotStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.task_stage = kwargs.get('task_stage', int())
        from geometry_msgs.msg import Pose2D
        self.pose = kwargs.get('pose', Pose2D())
        self.align_yaw = kwargs.get('align_yaw', bool())
    ...
    def __eq__(self, other):
        ...
        if self.robot_id != other.robot_id:
            return False
        if self.task_stage != other.task_stage:
            return False
        if self.pose != other.pose:
            return False
        if self.align_yaw != other.align_yaw:
            return False
        return True
    ...
    @property
    def task_stage(self):
        """Message field 'task_stage'."""
        return self._task_stage

    @task_stage.setter
    def task_stage(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'task_stage' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'task_stage' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._task_stage = value
    ...
    @property
    def align_yaw(self):
        """Message field 'align_yaw'."""
        return self._align_yaw

    @align_yaw.setter
    def align_yaw(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'align_yaw' field must be of type 'bool'"
        self._align_yaw = value
