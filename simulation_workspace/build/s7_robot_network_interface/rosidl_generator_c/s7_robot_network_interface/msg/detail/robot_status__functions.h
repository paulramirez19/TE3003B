...
#ifndef S7_ROBOT_NETWORK_INTERFACE__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
#define S7_ROBOT_NETWORK_INTERFACE__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
 ...
 * calls
 * s7_robot_network_interface__msg__RobotStatus__init().
...
/**
 * It calls
 * s7_robot_network_interface__msg__RobotStatus__fini()
 ...
 * s7_robot_network_interface__msg__RobotStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * s7_robot_network_interface__msg__RobotStatus__Sequence__fini()
 * on the array,
...
#endif  // S7_ROBOT_NETWORK_INTERFACE__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
