...
#include "s7_robot_network_interface/msg/detail/robot_status__rosidl_typesupport_fastrtps_c.h"
...
using _RobotStatus__ros_msg_type = s7_robot_network_interface__msg__RobotStatus;
...
static uint32_t _RobotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_s7_robot_network_interface__msg__RobotStatus(
...
{
  return max_serialized_size_s7_robot_network_interface__msg__RobotStatus(
    full_bounded, 0);
}
